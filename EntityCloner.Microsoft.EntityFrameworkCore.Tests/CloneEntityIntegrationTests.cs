...
{
    public class CloneEntityEnumerableIntegrationTests : DbContextTestBase
    {
        ...
        public CloneEntityEnumerableIntegrationTests() : base(nameof(CloneEntityEnumerableIntegrationTests))
        {
